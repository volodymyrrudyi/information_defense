...
void MainWindow::on_btnEncrypt_clicked()
{
    ...
    QString input = this->ui->editMessage->document()->toPlainText();
...
void MainWindow::on_editMessage_textChanged()
{
    ...
    QString strLength = QString("Text length: ") +
                                QString::number(this->ui->editMessage->document()->toPlainText().length());
...
void MainWindow::check_input()
{
    ...
    int input_length = this->ui->editMessage->document()->toPlainText().length();
